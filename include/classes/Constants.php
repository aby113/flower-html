...
class Constants {
	...
	public static $passwordsDoNoMatch = "비밀번호가 일치 하지않습니다.";
	public static $passwordNotAlphanumeric = "Your password can only contain numbers and letters";
	public static $passwordCharacters = "비밀번호는 5자 이상 30자 이하로 적어주셔야합니다.";
	public static $emailInvalid = "유효하지않은 이메일 입니다.";
