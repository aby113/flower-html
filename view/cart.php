                        ...
                        <tr>
                            <td rowspan="2" class="ta-c cb-array">
                                <span class="form-element">
                                    <input type="checkbox" name="cart_no[]" id="checkbox" value="14" class="checkbox"
                                        checked="checked" data-totalcnt="<?=$vo['totalcnt'] ?>" data-amount="<?=$vo['amount'] ?>">
                            ...
                            <td class="ta-c count this-product">
                                <span class="count">
                                    <input type="text" class="goods-cnt" title="수량" data-key="0" name="amount[]"
                            ...
                            <td class="ta-c this-product">
                                <strong class="price"><?=number_format($vo['totalcnt'])?>원</strong>
                            </td>
...
?>
                ...
                <div class="price-box">
                    <p>
                        <span class="detail">총 <strong><?=$prodCnt?></strong>개의 상품금액
                            <strong>
                                <?=number_format($totalCnt);?>원
                            </strong>
                        </span>
            ...
            <div class="footer">
                <div class="btn-group">
                    <div class="left-box">
                        <button type="button" class="btn btn-outline-warning delBtn">선택 상품 삭제</button>
